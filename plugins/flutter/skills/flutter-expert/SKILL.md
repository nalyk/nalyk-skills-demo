...
**Read the relevant reference file before providing detailed code.**

| # | Topic | File | Covers |
|---|---|---|---|
| 1 | Architecture | `reference/architecture-patterns.md` | Small/Medium/Large/Monorepo scaffolds, DI, flavors, migration |
| 2 | State Mgmt | `reference/state-management.md` | Riverpod 2.0, BLoC/Cubit, Provider, comparison matrix |
| 3 | Templates | `reference/code-templates.md` | Freezed, repository, GoRouter, forms, responsive, widgets, tests, i18n |
| 4 | Quality | `reference/quality-gates.md` | 60+ lint rules, CI/CD, coverage, pre-commit hooks, release, profiling |
...
3. **Answer with specific code patterns, scaffold commands, and concrete details**
4. **Follow the phased workflow below** for new projects or comprehensive tasks

### Topic → File Routing

- Project scaffolding, structure, DI, flavors → `reference/architecture-patterns.md`
- State management, Riverpod, BLoC, Provider → `reference/state-management.md`
- Code templates, Freezed, GoRouter, forms, tests → `reference/code-templates.md`
- Linting, CI/CD, coverage, release, profiling → `reference/quality-gates.md`
...
**Read `reference/architecture-patterns.md` for full scaffold commands and templates per size.**
...
**Read `reference/state-management.md` for implementation templates for each approach.**
...
**Read `reference/code-templates.md` for copy-paste templates for each step.**
...
**Read `reference/code-templates.md` § Navigation for the full router setup with auth guards, shell routes, and deep linking.**
...
**Read `reference/quality-gates.md` for the full CI pipeline config, custom lint rules, and pre-commit hooks.**
...
**Read `reference/code-templates.md` § Freezed Models for the model generation workflow.**
...
| File | When to read |
|---|---|
| `reference/architecture-patterns.md` | Scaffolding new projects or restructuring existing ones |
| `reference/state-management.md` | Implementing providers, BLoCs, or migrating state approach |
| `reference/code-templates.md` | Need copy-paste templates for models, screens, tests, routing |
| `reference/quality-gates.md` | Setting up CI/CD, linting, pre-commit hooks, release pipeline |
